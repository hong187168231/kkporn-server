...
public class KpnSiteAdvertiseController {
    ...
    public Result saveOrUpdateAdvertise(@Valid KpnSiteAdvertise advertise,@Valid @RequestParam("file") MultipartFile file, @LoginUser SysUser sysUser) throws Exception {
