        ...
        try {
            ...
            for (KpnSite kpnSite : kpnSites) {
                ...
                for (Long tagId : tagIds) {
                    ...
                    List<Long> movieIdsByVvDesc = movieTagService.getTageMovieIdsSortedByColumn(sid, tagId, PornConstants.Sql.COLUMN_VV);
                    ...
                    List<Long> movieIdsByDuration = movieTagService.getTageMovieIdsSortedByColumn(sid, tagId, PornConstants.Sql.COLUMN_DURATION);
                    RedisRepository.delete(redisKey);
                    ...
                    List<Long> movieIdsByCreateTime = movieTagService.getTageMovieIdsSortedByColumn(sid, tagId, PornConstants.Sql.COLUMN_CREATE_TIME);
                    RedisRepository.delete(redisKey);
